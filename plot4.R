...
par(mfrow=c(2,2))
with(required_data, plot(FullTimeDate, Global_active_power, type="l", xlab="", ylab="Global Active Power"))
with(required_data, plot(FullTimeDate, Voltage, type = "l", xlab="datetime", ylab="Voltage"))
with(required_data, plot(FullTimeDate, Sub_metering_1, type="l", xlab="", ylab="Energy sub metering"))
...
with(required_data, plot(FullTimeDate, Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power"))
dev.off()